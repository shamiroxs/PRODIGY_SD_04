...
def recognize_sudoku():
    # Directory containing segmented cells
    ...
    for row in range(9):
        for col in range(9):
            ...
            # Invert colors (Tesseract reads black text on white background better)
            ...
            try:
                ...
                # If OCR doesn't recognize a digit, keep it as 0
                sudoku_matrix[row][col] = 0

    # Print the recognized Sudoku matrix
    print("Sudoku Matrix:")
